...
public:
    void build_part1(const std::string &part)
    {
        m_data.append(part);
    }
    void build_part2(const std::string &part)
    {
        m_data.append(part);
    }
    void build_part3(const std::string &part)
    {
        m_data.append(part);
    }
    void do_something()
...
public:
    ...
    product get_concrete1() const
    {
        return m_builder_list[0]->get_result();
    }
    product get_concrete2() const
    {
        return m_builder_list[1]->get_result();
    }
    void destrcut()
    {
        if (m_builder_list[0])
