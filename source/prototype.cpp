...
public:
    ...
    {
        return new concrete_prototype1();
    }
};
...
public:
    ...
    prototype *clone() const override
    {
        return new concrete_prototype2();
    }
};
class client
{
...
public:
    ...
    prototype *clone_concrete_prototype1()
    {
        return prototype_list[0]->clone();
    }
    prototype *clone_concrete_prototype2()
    {
        return prototype_list[1]->clone();
    }
    virtual ~client() {}
};
