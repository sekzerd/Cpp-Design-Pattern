...
public:
    ...
    void add_behavior(std::function<void()> function)
    {
        m_function = function;
    }
};
int main(const int argc, const char **argv)
{
    ...
    concrete_decorator_A *_concrete_decorator_A = new concrete_decorator_A(_concrete_component);
    _concrete_decorator_A->add_state(1);

    concrete_decorator_B *_concrete_decorator_B = new concrete_decorator_B(_concrete_decorator_A);
